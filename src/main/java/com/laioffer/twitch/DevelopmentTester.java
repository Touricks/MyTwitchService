...
public class DevelopmentTester implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        ItemEntity videoEntity = new ItemEntity("1", videos.get(0));
        ItemEntity clipEntity = new ItemEntity( clips.get(0));
        ItemEntity streamEntity = new ItemEntity(streams.get(0));
    }
}
